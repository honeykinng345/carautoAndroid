package com.example.androidautodemo.templates.navigation.nav;
...
import com.example.androidautodemo.MainActivity;
import com.example.androidautodemo.MyCarAppService;
import com.example.androidautodemo.R;
import com.example.androidautodemo.nevigationtemplate.common.Instruction;
import com.example.androidautodemo.nevigationtemplate.common.Script;
    ...
    private Notification getNotification(
        ...
        if (showInCar) {
            Intent intent = new Intent(Intent.ACTION_VIEW)
                    .setComponent(new ComponentName(this, MyCarAppService.class))
                    .setData(MyCarAppService.createDeepLinkUri(Intent.ACTION_VIEW));
            builder.extend(
